...
pub const FORM_POLICIES: &[FormPolicy] = &[
  ...
  FormPolicy { file: "08", opcode_bytes: &[0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "OR (step.rs:459)" },
  FormPolicy { file: "09", opcode_bytes: &[0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "OR (step.rs:459)" },
  FormPolicy { file: "0A", opcode_bytes: &[0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "OR (step.rs:459)" },
  FormPolicy { file: "0B", opcode_bytes: &[0x0B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "OR (step.rs:459)" },
  FormPolicy { file: "0C", opcode_bytes: &[0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "OR (step.rs:459)" },
  FormPolicy { file: "0D", opcode_bytes: &[0x0D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "OR (step.rs:459)" },
  ...
  FormPolicy { file: "20", opcode_bytes: &[0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "AND (step.rs:458)" },
  FormPolicy { file: "21", opcode_bytes: &[0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "AND (step.rs:458)" },
  FormPolicy { file: "22", opcode_bytes: &[0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "AND (step.rs:458)" },
  FormPolicy { file: "23", opcode_bytes: &[0x23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "AND (step.rs:458)" },
  FormPolicy { file: "24", opcode_bytes: &[0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "AND (step.rs:458)" },
  FormPolicy { file: "25", opcode_bytes: &[0x25, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "AND (step.rs:458)" },
  ...
  FormPolicy { file: "30", opcode_bytes: &[0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "XOR (step.rs:460)" },
  FormPolicy { file: "31", opcode_bytes: &[0x31, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "XOR (step.rs:460)" },
  FormPolicy { file: "32", opcode_bytes: &[0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "XOR (step.rs:460)" },
  FormPolicy { file: "33", opcode_bytes: &[0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "XOR (step.rs:460)" },
  FormPolicy { file: "34", opcode_bytes: &[0x34, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "XOR (step.rs:460)" },
  FormPolicy { file: "35", opcode_bytes: &[0x35, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "XOR (step.rs:460)" },
  ...
  FormPolicy { file: "69", opcode_bytes: &[0x69, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0801), note: "IMUL r16,rm16,imm16 (step.rs:472); CF/OF defined, rest undefined (Intel 80286)" },
  ...
  FormPolicy { file: "6B", opcode_bytes: &[0x6B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0801), note: "IMUL r16,rm16,imm8 (step.rs:472); CF/OF defined, rest undefined (Intel 80286)" },
  ...
  FormPolicy { file: "80.1", opcode_bytes: &[0x80, 0xC0 | (1 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "OR grp1 (step.rs:459)" },
  ...
  FormPolicy { file: "80.4", opcode_bytes: &[0x80, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "AND grp1 (step.rs:458)" },
  ...
  FormPolicy { file: "80.6", opcode_bytes: &[0x80, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "XOR grp1 (step.rs:460)" },
  ...
  FormPolicy { file: "81.1", opcode_bytes: &[0x81, 0xC0 | (1 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "OR grp1 (step.rs:459)" },
  ...
  FormPolicy { file: "81.4", opcode_bytes: &[0x81, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "AND grp1 (step.rs:458)" },
  ...
  FormPolicy { file: "81.6", opcode_bytes: &[0x81, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "XOR grp1 (step.rs:460)" },
  ...
  FormPolicy { file: "82.1", opcode_bytes: &[0x82, 0xC0 | (1 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "OR grp1 (step.rs:459)" },
  ...
  FormPolicy { file: "82.4", opcode_bytes: &[0x82, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "AND grp1 (step.rs:458)" },
  ...
  FormPolicy { file: "82.6", opcode_bytes: &[0x82, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "XOR grp1 (step.rs:460)" },
  ...
  FormPolicy { file: "83.1", opcode_bytes: &[0x83, 0xC0 | (1 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "OR grp1 (step.rs:459)" },
  ...
  FormPolicy { file: "83.4", opcode_bytes: &[0x83, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "AND grp1 (step.rs:458)" },
  ...
  FormPolicy { file: "83.6", opcode_bytes: &[0x83, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "XOR grp1 (step.rs:460)" },
  ...
  FormPolicy { file: "84", opcode_bytes: &[0x84, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "TEST rm8,r8 (step.rs:448)" },
  FormPolicy { file: "85", opcode_bytes: &[0x85, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "TEST rm16,r16 (step.rs:448)" },
  ...
  FormPolicy { file: "C0.0", opcode_bytes: &[0xC0, 0xC0 | (0 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "ROL grp2 (step.rs:469)" },
  ...
  FormPolicy { file: "C0.4", opcode_bytes: &[0xC0, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "C0.5", opcode_bytes: &[0xC0, 0xC0 | (5 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHR grp2 (step.rs:467)" },
  FormPolicy { file: "C0.6", opcode_bytes: &[0xC0, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "C0.7", opcode_bytes: &[0xC0, 0xC0 | (7 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SAR grp2 (step.rs:468)" },
  FormPolicy { file: "C1.0", opcode_bytes: &[0xC1, 0xC0 | (0 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "ROL grp2 (step.rs:469)" },
  ...
  FormPolicy { file: "C1.4", opcode_bytes: &[0xC1, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "C1.5", opcode_bytes: &[0xC1, 0xC0 | (5 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHR grp2 (step.rs:467)" },
  FormPolicy { file: "C1.6", opcode_bytes: &[0xC1, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "C1.7", opcode_bytes: &[0xC1, 0xC0 | (7 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SAR grp2 (step.rs:468)" },
  ...
  FormPolicy { file: "D0.0", opcode_bytes: &[0xD0, 0xC0 | (0 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "ROL grp2 (step.rs:469)" },
  ...
  FormPolicy { file: "D0.4", opcode_bytes: &[0xD0, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "D0.5", opcode_bytes: &[0xD0, 0xC0 | (5 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "SHR grp2 (step.rs:467)" },
  FormPolicy { file: "D0.6", opcode_bytes: &[0xD0, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "D0.7", opcode_bytes: &[0xD0, 0xC0 | (7 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "SAR grp2 (step.rs:468)" },
  FormPolicy { file: "D1.0", opcode_bytes: &[0xD1, 0xC0 | (0 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "ROL grp2 (step.rs:469)" },
  ...
  FormPolicy { file: "D1.4", opcode_bytes: &[0xD1, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "D1.5", opcode_bytes: &[0xD1, 0xC0 | (5 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "SHR grp2 (step.rs:467)" },
  FormPolicy { file: "D1.6", opcode_bytes: &[0xD1, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "D1.7", opcode_bytes: &[0xD1, 0xC0 | (7 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "SAR grp2 (step.rs:468)" },
  FormPolicy { file: "D2.0", opcode_bytes: &[0xD2, 0xC0 | (0 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "ROL grp2 (step.rs:469)" },
  ...
  FormPolicy { file: "D2.4", opcode_bytes: &[0xD2, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "D2.5", opcode_bytes: &[0xD2, 0xC0 | (5 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHR grp2 (step.rs:467)" },
  FormPolicy { file: "D2.6", opcode_bytes: &[0xD2, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "D2.7", opcode_bytes: &[0xD2, 0xC0 | (7 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SAR grp2 (step.rs:468)" },
  FormPolicy { file: "D3.0", opcode_bytes: &[0xD3, 0xC0 | (0 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "ROL grp2 (step.rs:469)" },
  ...
  FormPolicy { file: "D3.4", opcode_bytes: &[0xD3, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "D3.5", opcode_bytes: &[0xD3, 0xC0 | (5 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHR grp2 (step.rs:467)" },
  FormPolicy { file: "D3.6", opcode_bytes: &[0xD3, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SHL grp2 (step.rs:466)" },
  FormPolicy { file: "D3.7", opcode_bytes: &[0xD3, 0xC0 | (7 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x07C7), note: "SAR grp2 (step.rs:468)" },
  ...
  FormPolicy { file: "F6.0", opcode_bytes: &[0xF6, 0xC0 | (0 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "TEST grp3 (step.rs:448)" },
  FormPolicy { file: "F6.1", opcode_bytes: &[0xF6, 0xC0 | (1 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "TEST grp3 (step.rs:448)" },
  ...
  FormPolicy { file: "F6.6", opcode_bytes: &[0xF6, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::DecodeOnly, scope: Scope::Deferred(DeferReason::NotImplemented), flags_umask: Some(0x0000), note: "8-bit DIV/IDIV decodes but step.rs divmod asserts u32/u16 lhs/rhs (alu.rs:134-135) -> PANIC; umask 0x0000 recorded (flags undefined per Intel)" },
  FormPolicy { file: "F6.7", opcode_bytes: &[0xF6, 0xC0 | (7 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::DecodeOnly, scope: Scope::Deferred(DeferReason::NotImplemented), flags_umask: Some(0x0000), note: "8-bit DIV/IDIV decodes but step.rs divmod asserts u32/u16 lhs/rhs (alu.rs:134-135) -> PANIC; umask 0x0000 recorded (flags undefined per Intel)" },
  FormPolicy { file: "F7.0", opcode_bytes: &[0xF7, 0xC0 | (0 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "TEST grp3 (step.rs:448)" },
  FormPolicy { file: "F7.1", opcode_bytes: &[0xF7, 0xC0 | (1 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0FC7), note: "TEST grp3 (step.rs:448)" },
  ...
  FormPolicy { file: "F7.4", opcode_bytes: &[0xF7, 0xC0 | (4 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0801), note: "MUL grp3 (step.rs:490); CF/OF defined, rest UNDEFINED (Intel 80286) -> umask 0x0801" },
  FormPolicy { file: "F7.5", opcode_bytes: &[0xF7, 0xC0 | (5 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0801), note: "IMUL grp3 (step.rs:491); CF/OF defined, rest UNDEFINED (Intel 80286) -> umask 0x0801" },
  FormPolicy { file: "F7.6", opcode_bytes: &[0xF7, 0xC0 | (6 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0000), note: "DIV grp3 (step.rs:494); all status flags UNDEFINED (Intel 80286) -> umask 0x0000" },
  FormPolicy { file: "F7.7", opcode_bytes: &[0xF7, 0xC0 | (7 << 3), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], cap: Capability::Implemented, scope: Scope::V1, flags_umask: Some(0x0000), note: "IDIV grp3 (step.rs:495); all status flags UNDEFINED (Intel 80286) -> umask 0x0000" },
...
mod tests {
  ...
  fn umask_overrides_are_computed_per_intel_docs() {
    ...
    // Logical ops (OR/AND/XOR/TEST) mask AF (undefined per Intel 80286).
    assert_eq!(policy_for_file("08").unwrap().flags_umask, Some(0x0FC7));
    assert_eq!(policy_for_file("F7.0").unwrap().flags_umask, Some(0x0FC7));
    // Shifts by 1 (count==1) mask AF; OF is defined for count==1.
    assert_eq!(policy_for_file("D1.4").unwrap().flags_umask, Some(0x0FC7));
    // Variable-count shifts mask AF+OF (OF undefined for count>1).
    assert_eq!(policy_for_file("C0.4").unwrap().flags_umask, Some(0x07C7));
    assert_eq!(policy_for_file("D2.4").unwrap().flags_umask, Some(0x07C7));
    // IMUL imm forms: CF/OF only.
    assert_eq!(policy_for_file("69").unwrap().flags_umask, Some(0x0801));
    // ADD (AL,imm8) still defaults to the full runner mask.
