...
const ABI_SIZE: usize = 80;

const OFF_ABI_VERSION: usize = 0;
const OFF_STRUCT_SIZE: usize = 4;
const OFF_INIT: usize = 8;
const OFF_END: usize = 12;
const OFF_RUNTIME_PSP: usize = 20;
const OFF_REQ: usize = 24;
const OFF_ACK: usize = 32;
const OFF_DECODED: usize = 40;
const OFF_STEP_FLAGS: usize = 44;
const OFF_AX: usize = 48;
const OFF_IP: usize = 64;
const OFF_CS: usize = 66;
